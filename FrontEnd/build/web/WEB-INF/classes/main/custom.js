...
$(window).on("load", async function () {
  ...
  try {
    ...
    console.log("popularesArrayaquiii",peliculasPopularesArray);
    ...
    let peliculasQueSaldranFetch = await fetch(
		...
		peliculasQueSaldranID = peliculasQueSaldranID["Movies Upcoming"];
		...
		try{
			...
			for(let x in peliculasPopularesArray){
				...
				innerHTML += `<div class="slide-it" ">
				<div class="movie-item">
					<div class="mv-img">
						<img src="${peliculasPopularesArray[x].image_url}" alt="">
					</div>
					<div class="hvr-inner">
						<a  href="moviesingle.html"> Read more <i class="ion-android-arrow-dropright"></i> </a>
					</div>
					<div class="title-in">
						<h6><a href="#">${peliculasPopularesArray[x].title}</a></h6>
						<p><i class="ion-android-star"></i><span>${peliculasPopularesArray[x].rating}</span> /10</p>
					</div>
				</div>
			</div>`
		...
		try{
			...
			for(let x in peliculasQueSaldranArray){
				...
				<div class="movie-item">
					<div class="mv-img">
						<img src="${peliculasQueSaldranArray[x].image_url}" alt="">
					</div>
					<div class="hvr-inner">
						<a  href="moviesingle.html"> Read more <i class="ion-android-arrow-dropright"></i> </a>
					</div>
					<div class="title-in">
						<h6><a href="#">${peliculasQueSaldranArray[x].title}</a></h6>
						<p><i class="ion-android-arrow-dropright"></i><span>${fecha[2]}-${fecha[1]}-${fecha[0][2]}${fecha[0][3]}</span></p>
					</div>
				</div>
			</div>`
